...
cd ..
echo Removing top-level installation directory: C:\mongodriver\mongoc\
(rmdir C:\mongodriver\mongoc\ 2>NUL) || echo ... not removed (probably not empty)
