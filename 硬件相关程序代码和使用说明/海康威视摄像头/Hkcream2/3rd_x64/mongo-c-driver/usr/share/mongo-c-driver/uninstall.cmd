...
pushd D:\work_code\mongo-c-driver\usr\
...
echo Removing file bin\libbson-1.0.dll
del bin\libbson-1.0.dll || echo ... not removed
...
echo Removing file bin\libmongoc-1.0.dll
del bin\libmongoc-1.0.dll || echo ... not removed
...
cd ..
echo Removing top-level installation directory: D:\work_code\mongo-c-driver\usr\
(rmdir D:\work_code\mongo-c-driver\usr\ 2>NUL) || echo ... not removed (probably not empty)
